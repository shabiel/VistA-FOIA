ORQQPL1 ; ALB/PDR/REV - PROBLEM LIST FOR CPRS GUI ; 03/12/13
...
EDLOAD(RETURN,DA,GMPROV,GMPVAMC) ; LOAD  EDIT ARRAYS
 ; DA=problem IFN
 N I,GMPL
 S %=$$DETAIL^GMPLAPI2(.GMPL,DA,.GMPLMGR,.GMPROV)
 S I=0
...
EDSAVE(RETURN,GMPIFN,GMPROV,GMPVAMC,UT,EDARRAY) ; SAVE EDITED RES
 ...
 . I '$$LOCK^GMPLDAL(GMPIFN,11) S RETURN=0 ; given bogus nature of this lock, should be able to get
...
DUP(Y,DFN,TERM,TEXT) ;Check for duplicate problem
 N ACTIVE
 S %=$$DUPL^GMPLAPI2(.Y,DFN,TERM,TEXT)
 Q:Y=0 
