...
DQ U IO S POP=0
 ...
 ..I $G(R1ACNOD)]"" S (R1ACBLU,R1ACBLZ)="",R1ACBLU=$P($G(R1ACNOD),U) I $G(R1ACBLU)]"" S R1ACBLZ=$P($G(^DIZ(612418.1,R1ACBLU,0)),U)
 ...
 ..S ^XTMP("XEROX_DIAG",R1ACCLN)=R1ACCLN_U_$G(R1ACBLZ)_U_R1ACB1_U_R1ACB2_U_R1ACB3_U_R1ACB4_U_R1ACB5_U_R1ACB6_U_R1ACB7_U_R1ACB8_U_R1ACB9_U_R1ACB10_U_R1ACB11_U_R1ACB12_U_R1ACB13_U_R1ACB14_U_R1ACB15
 ..S (R1ACB1,R1ACB2,R1ACB3,R1ACB4,R1ACB5,R1ACB6,R1ACB7,R1ACB8,R1ACB9,R1ACB10,R1ACB11,R1ACB12,R1ACB13,R1ACB14,R1ACB15)=""
 Q
EXIT ;
 K ^XTMP("XEROX_DIAG")
...
EN2 ;
 ...
 Q
HDR ;
 W !,"Clinic"_U_"Boiler Plate"_U_"#1"_U_"#2"_U_"#3"_U_"#4"_U_"#5"_U_"#6"_U_"#7"_U_"#8"_U_"#9"_U_"#10"_U_"#11"_U_"#12"_U_"#13"_U_"#14"_U_"#15"
 Q
TEST ;
