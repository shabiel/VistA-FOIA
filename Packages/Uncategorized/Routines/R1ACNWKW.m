...
EDIT ;
 ...
 .W "</TEXTAREA>"
 W "</br>"
 ;W "<input type=""submit"" name=""btn2Save"" value=""6) Save Template"" tabindex=""23"" onclick=""document.body.style.cursor='wait';"" />"
 W "&nbsp;"
 W "<input type=""submit"" name=""btnLogout"" value=""Logout"" tabindex=""24"" />"
 Q
SAVEDATA(DA,R1ACFLD) ;Save the user's new templated data for each type
