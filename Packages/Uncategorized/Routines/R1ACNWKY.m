R1ACNWKY ;VISN21/NLS/-Display for Print Post Card Setup Templates
 ...
 S (ARHDEXIT,ARHDFDA,ARHDIENS,ARHDIENZ,BPDA,CBXC1,CBXC2,CBXT,CNT,DA,DAZ,DIWP,NODE,NTYPE,R1ACFLDZ,R1ACFLG,R1ACIEN,R1ACIENS,REF)=""
 ...
 ...K ARHDFDA S ARHDFDA(612418.1,DA_",",.02)=CBXT D FILE^DIE("","ARHDFDA") K ^TMP("SSSXXX") ;Set primary field in new boiler plate entries
 ...L -^DIZ(612418.1,DA,0)
 ...
 .I CNT>9 D ALERT2
 .W "</br>"
 .W "<input type=""submit"" name=""btn2Save"" value=""6) Save Boiler Plate"" tabindex=""23"" onclick=""document.body.style.cursor='wait';"" />"
 .I $G(BPDA)]""&($G(DAZ)]"") D ARCHV2^R1ACNWKV(BPDA,DAZ) S R1ACFLG=1 ;BP, CLIN1 - transfers wp lines from #612418 ==> #612418.1
 .W "</br><input type=""button"" value=""7) Refresh Page before Next Clinic Selection"" tabindex=""24"" title=""clear drop down box & all memo boxes"" onClick=""window.location.href=window.location.href"">"
 .Q
 I $G(R1ACFLG)]"" Q
 ...
 .W "</TEXTAREA>"
 .W "</br>"
 .W "<input type=""submit"" name=""btn2Save"" value=""Save Template"" tabindex=""23"" onclick=""document.body.style.cursor='wait';"" />"
 .Q:($G(BPDA)']"")
 Q
EDIT ;
...
SAVEDATA(DA,R1ACFLD) ;
 ...
 K ARHDFDA
 Q
SAVE2(ARHDIENS,R1ACFLD) ;Save New Boiler Plate w/o attaching to a clinic
 K ARHDMSG
 K ARHDMSGS("*")
...
ALERT1 ;Line Length > 65 characters
 ...
 S ARHDMSG="Only 63 keystrokes per line are permitted! Please re-adjust. At least this line # exceeds 63 characters:  #"_$G(CNTZ)
