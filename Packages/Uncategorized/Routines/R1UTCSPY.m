...
ALPHASCR(ARHDVALU,ARHDALPH) ;
 ...
 Q ARHDOKAY
 ;
SELECT(ARHDROOT,ARHDATTR,ARHD0,ARHDLIST,ARHDAPI,ARHDFILE,ARHDIENS,ARHDFLDS,ARHDFLAG,ARHDNUMB,ARHDFROM,ARHDVALU,ARHDXREF,ARHDSCRN,ARHDIDEN) ;
 ; *** Make <select> tag
 ; Input
 ...
 .. D LIST^DIC($G(ARHDFILE),$G(ARHDIENS),$G(ARHDFLDS),$G(ARHDFLAG),$G(ARHDNUMB),$G(ARHDFROM),$G(ARHDVALU),$G(ARHDXREF),$G(ARHDSCRN),$G(ARHDIDEN),ARHDTARG) ;DBIA:2051
 .. Q
 . I $$UP^XLFSTR($G(ARHDAPI))="FIND" D  ;DBIA:10104
 .. D FIND^DIC($G(ARHDFILE),$G(ARHDIENS),$G(ARHDFLDS),$G(ARHDFLAG),$G(ARHDVALU),$G(ARHDNUMB),$G(ARHDXREF),$G(ARHDSCRN),$G(ARHDIDEN),ARHDTARG) ;DBIA:2051
 .. Q
