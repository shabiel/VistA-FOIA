...
FTP ;
 ...
 ;
 N R1ACCMD,R1ACFILE,R1ACDFIL,R1ACPATH,R1ACDPTH,R1ACIN,R1ACLOG,R1ACSUBM,R1ACUSR,R1ACPASS,R1ACF1,R1ACF2,R1ACN1,R1ACN2,R1ACSVR,R1ACSTT
 S R1ACFILE=""
 S R1ACSTT=$P($G(^DIZ(612418.5,1,0)),U,9) ; Transmission Type (FTP vs SFTP)
...
XMIT0 ;
 ...
 S (R1ACDPTH,R1ACPATH)=$P($G(^DIZ(612418.5,1,0)),U,2)  Q:R1ACPATH=""  S R1ACPATH=$P(R1ACPATH,"]")_".INPUT]",R1ACDPTH=$P(R1ACDPTH,"]")_".PCARD]"
 ...
 .S X=$S(R1ACSTT="S":"@"_R1ACDPTH_R1ACCFIL,1:"PIPE FTP "_R1ACSVR_"/USER="_R1ACUSR_"/PASS="""_R1ACPASS_"""/INPUT="_R1ACIN_">"_R1ACLOG)
 .; now execute script
 .D ZFEXEC^R1ACSUTL(X)
 .Q
