SDMULT1 ;ALB/TMP - MAKE MULTI-CLINIC APPOINTMENTS ; 5/21/13
...
TM S SDMADE=0 R !!,"SCHEDULE TIME: ",X:DTIME Q:"^"[X!'($T)  I X?.E1"?"!(X'?1N.N) W !,"Enter the appointment time for this clinic" G TM
 ...
 I ERR=0,$P(ERR(0),U)="APTOVBK",$G(ERR(1)) W !,"  WHEN??" G TM
 I ERR=0,$P(ERR(0),U)="APTPHSD"!($P(ERR(0),U)="APTOVBK") S TXT(1)=$P(ERR(0),U,2)_"...OK",OV=$$OVB^SDM1(.TXT,$S($P(ERR(0),U)="APTOVBK":2,1:1)) I OV=2 G TM
 D ^SDM4
 D MAKEM^SDM1(DFN,SC,SDT,SDAPTYP,.SDXSCAT,.SLL)
 S SDMADE=1
