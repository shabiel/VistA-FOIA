...
EN1
 ...
 K ERR D CLNRGHT^SDMAPI1(.ERR,+SC) I ERR=0 W !,*7,$P(ERR(0),U,2) S:$D(SDCLN) SDAMERR="" G END:$D(SDCLN),SDM
 D CS^SDM1A S SDW="",WY="Y"
 S ROU="LSTPATS^SDMAPI3",PRMPT="Select PATIENT NAME: "
 S FILE="HOSPITAL LOCATION",FIELDS="NAME, or ABBREVIATION, or TEAM"
...
PEND S %=""
 D HASPEND^SDMAPI2(.PEND,DFN,DT) W:PEND=0 !,"NO PENDING APPOINTMENTS"
 ...
 . S ROU="LSTETNS^SDMAPI3",PRMPT="Select ETHNICITY: "
 . S FILE="ETHNICITY",FIELDS=""
 . S ETN=$$SELECT^SDMUTL(ROU,PRMPT,FILE,FIELDS)
 . I +ETN>0 D SETETN^SDMAPI3(DFN,ETN)
...
RACE ; Set race
 ...
 S ROU="LSTRACES^SDMAPI3",PRMPT="Select RACE: "
 S FILE="RACE",FIELDS="",ROU1="GETPRES^SDMAPI3(.EXS,DFN)"
...
SETRACE ;
 ...
 I +ETN>0  D
 . N RES
 . D GETPRES^SDMAPI3(.RES,DFN)
 . S ADD=$$ASKADD($P(ETN,U,2),+RES(0))
 . D:ADD SETRACE^SDMAPI3(DFN,ETN) 
 . D SETRACE
 Q
HLP1 ;
