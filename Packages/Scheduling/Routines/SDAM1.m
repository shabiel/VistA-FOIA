SDAM1 ;MJK/ALB - Appt Mgt (Patient);5/31/2013
...
BLD ; -- scan apts
 ...
 S %=$$LSTPAPTS^SDMAPI1(.RETURN,DFN,SDBEG,SDEND,STAT)
 D BLD1^SDAM1(.RETURN)
...
BLD1(APTS) ; -- build array
 ...
 . S SDT=APTS(IND,"DATE"),BID=APTS(IND,"BID")
 . S GAF=APTS(IND,"GAF")
 . S NAME=$S(SDAMTYP="P":$P(APTS(IND,"CLINIC"),U,2),1:BID_" "_$P(APTS(IND,"PATIENT"),U,2))
 . S DFN=+APTS(IND,"PATIENT"),SDCL=+APTS(IND,"CLINIC")
 . S STAT=APTS(IND,"STAT")
