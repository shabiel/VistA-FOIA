SDWLDISP ;;IOFO BAY PINES/TEH - WAIT LIST - DISPOSITION WAIT LIST ENTRY;3/18/13
 ...
 ;
EN ;
 N HASENTRY,SDWLIEN,SDWLDATA,SDWLERR,SDWLDISP,DIR,SDWLOP,VADM
 S SDWLOP="",SDWLERR=0
 I $D(SDWLLIST),SDWLLIST D
 . I $G(DFN)'>0 S SDWLERR=1 Q
 . I $D(DFN),'$$HASENTRY^SDWLAPI1(.HASENTRY,DFN)!'HASENTRY D NOENTRY Q
 I 'SDWLERR,$D(SDWLLIST),SDWLLIST D HD S SDWLDFN=DFN D 1^VADPT,DEM^VADPT W !,VADM(1),?40,VA("PID")
 I '$G(DFN) D
 . D HD
 . S DFN=$$SELPAT ;SELECT PATIENT FROM EWL FILE
 . S SDWLOP="" D 1^VADPT,DEM^VADPT
 ...
 G ENQ:SDWLDISP=""
 D UPDATE(SDWLIEN,SDWLDISP,.SDWLDATA)
...
SELAPPT(SDWLIEN,SDWLDATA,SDWLAPPT) ;SELECT APPOINTMENT TO CLOSE WITH
 ...
 Q 1
 ;
UPDATE(SDWLIEN,SDWLDISP,SDWLDATA) ;UPDATE EWL ENTRY
 ...
 S %=$$DISP^SDWLAPI1(.SDWLERR,SDWLIEN,SDWLDISP,.SDWLAPPT)
 Q
 ;
