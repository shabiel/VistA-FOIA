SDM1 ;SF/GFT - MAKE APPOINTMENT ; 5/21/13
...
ADT S:'$D(SDW) SDW=""
 ...
 G MAKE
 Q
MAKEM(DFN,SC,SD,SDAPTYP,SDXSCAT,SL) ;
 N LENMA S LENMA=1
 S TYP=SDAPTYP,STYP=$G(SDXSCAT),LVL=1
MAKE ; Make appointmemnt
 ...
 I '$G(LENMA),$P(CLN("VARIABLE APP'NTMENT LENGTH"),U)="V" D LEN Q:U=S
...
ASKOVB ;
 ...
 . S %=$$CANCEL^SDMAPI2(.RE,DFN,$G(APT("APT",+SD,"CLINIC")),SD,"C",13,"13",$G(APT("APT",+SD,"CLINIC")))
...
MERR ;
 ...
 I $P(ERR(0),U)="APTSDOB" D  G 1
 . D EN^DDIOL($$EZBLD^DIALOG($S($G(ERR(1)):480000.089,1:480000.122)),,$S($G(ERR(1)):"!,?2",1:"!!"))
