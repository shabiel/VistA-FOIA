SDM1 ;SF/GFT - MAKE APPOINTMENT ; 3/15/13
...
MAKE ; Make appointmemnt
 ...
 D EN^DDIOL($$EZBLD^DIALOG(480000.107,$G(SL)),,"!!")
...
OVB(TXT) ;
OVB1 ;
 S %=2 D EN^DDIOL(.TXT,,"*7") D YN^DICN
...
WRT N PAR,ALEN
 ...
 S:$P(CLN("VARIABLE APP'NTMENT LENGTH"),U)["V" PAR(2)="("_$P(CLN("VARIABLE APP'NTMENT LENGTH"),U,2)_")"
