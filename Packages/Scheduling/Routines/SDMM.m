SDMM ;SF/GFT,MAN/GRR - MULTIPLE APPOINTMENTS ; 3/7/13
 ;;5.3;Scheduling;**26,32,167,241,327,446,260003**;Aug 13, 1993;Build 77
...
ADT K SDERRFT S CCX=""
 ...
 N HOL
OVR S SDY1=$P(Y,".") S %=$$GETHOL^SDMAPI4(.HOL,SDY1) I $D(HOL(SDY1)),'SDSOH W *7,?50,$P(HOL(SDY1),U,2),"??" G ADT
