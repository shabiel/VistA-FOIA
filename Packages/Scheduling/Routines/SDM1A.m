SDM1A ;SF/GFT,ALB/TMP - MAKE APPOINTMENT ; 5/31/13
...
CS ;
 N ERR
 S %=$$GETCSC^SDMAPI1(.ERR,CLN("STOP CODE NUMBER"))
 I $S(ERR=0:1,$G(ERR("IDT"))="":0,1:$G(ERR("IDT"))'>$$DT^XLFDT()) D
 . W !!,*7,"** WARNING - CLINIC HAS AN INVALID OR INACTIVE STOP CODE!!!",!!
 K ERR S %=$$GETCSC^SDMAPI1(.ERR,CLN("CREDIT STOP CODE"))
 I $S(ERR=0:1,$G(ERR("IDT"))="":0,1:$G(ERR("IDT"))'>$$DT^XLFDT()) D
 . W !!,*7,"** WARNING - CLINIC HAS AN INVALID OR INACTIVE CREDIT STOP CODE!!!",!!
 Q
