SDMAPI2 ;RGI/VSL - APPOINTMENT API; 1/25/2013
...
MAKEUS(RETURN,DFN,SC,SD,TYP,STYP,CIO) ; Make unscheduled appointment
 ...
 K RETURN S RETURN=0
 S:$D(TYP) TYPE=+TYP
 S %=$$CHKPAR(.RETURN,.DFN,.SC,.TYPE,.STYP) Q:%=0 0
...
MAKE(RETURN,DFN,SC,SD,TYPE,STYP,LEN,SRT,OTHR,CIO,LAB,XRAY,EKG,RQXRAY,CONS,LVL) ; Make appointment
 ...
 I RETURN=1,$P($G(RETURN(0)),U)="APTPAHA" D
 . D GETAPTS^SDMDAL2(.APT,+DFN,+SD)
 . S %=$$CANCEL(.RETURN,+DFN,+APT("APT",+SD,"CLINIC"),+SD,"C",13,"")
 . K RETURN(0)
...
CHKRSN(RETURN,RSN,TYPE) ; Check cancellation reason
 ...
 I $E(TYP,1)'=$G(CRSN(2,"I")),$G(CRSN(2,"I"))'="B" D ERRX^SDAPIE(.RETURN,"INVPARAM","RSN") Q 0
 S RETURN=1
 Q 1
