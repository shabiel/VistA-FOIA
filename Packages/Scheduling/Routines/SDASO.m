SDASO ;MAN/GRR - APPEND TESTS TO PENDING APPOINTMENT ; 5/31/13
...
RD ;
 ...
 S %=$$LSTPAPTS^SDMAPI1(.APTS,+DFN,DT,,)
 S SDT=0,L=0,CNT=0
 ...
 . . S Z(L)=APTS(SDT,"DATE")_U_$P(APTS(SDT,"CLINIC"),U)_U_APTS(SDT,"LEN")_U_COMM
 . . S Z(L)=Z(L)_U_$P(APTS(SDT,"CLINIC"),U,2)_U_APTS(SDT,"OE")
 G:L'>0 NO
 F ZZ=1:1:L  D
 . W !!,ZZ,") "
