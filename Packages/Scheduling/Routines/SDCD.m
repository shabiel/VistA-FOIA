SDCD ;BSN/GRR - DISCHARGE PATIENT FROM CLINIC ;2/6/2013
...
15 D:'$D(DT) DT^SDUTL
 ...
 . I '$D(SENS(SDCLN,"EN")) D  Q
 . . W !!,*7,">>> Patient not enrolled in '",SENS(SDCLN,"NAME"),"' clinic." S SDAMERR=1
 . . S SDAMERR=1 D PAUSE^VALM1
 . I $G(SENS(SDCLN,"STATUS"))]"" D  Q
 ...
 . W !!,"***Discharging patient from ",ENRLS(VAUTC(IND),"NAME")," Clinic***",!
 . N ENS
 . M ENS(VAUTC(IND))=ENRLS(VAUTC(IND))
