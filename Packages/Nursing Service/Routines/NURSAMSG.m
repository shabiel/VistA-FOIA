NURSAMSG ;HIRMFO/RM,FPT-QUEUED MESSAGES TO THE CENT. NURS. OFFICE ;4/26/13
 ;;4.0;NURSING SERVICE;**260005**;Apr 25, 1997
...
BADPARAM ; ERROR IF NURSING SITE PARAMETERS HAVE NOT BEEN ADDED
 W:'$G(DGQUIET) !!,*7,*7,"Notify NURSING ADP Coordinator and Site Manager that this patient was not",!,"admitted into the NURSING Service because NURSING Site parameters were not",!,"updated."
 Q
