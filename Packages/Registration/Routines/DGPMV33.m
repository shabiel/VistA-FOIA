DGPMV33 ;ALB/MIR - DISCHARGE A PATIENT, CONTINUED ; 7/11/13
...
DICS ;input transform on discharge type
 ...
 I $G(DGPMAN)="" S DGER=1 Q
 ;I "^21^47^48^49^"[("^"_DGX1_"^") S DGER=1 Q
 I DGX1=42,'$O(^DGPM("ATID2",+DFN,9999999.9999999-$S($D(DGAPIDT):+DGAPIDT,1:+^DGPM(DA,0)))) S DGER=1 Q
