DGPMX1 ; GENERATED FROM 'DGPM ADMIT' INPUT TEMPLATE(#446), FILE 405;7/3/13
...
X4 I $D(X),'$D(DGPMT) D EN^DDIOL("USE BED CONTROL MOVEMENT OPTIONS!",,"!") K X
 ...
 Q
 ;
5 S DQ=5,DW="0;12",DV="R*P43.4'",DU="",DLB="ADMITTING REGULATION",DIFLD=.12
 S DU="DIC(43.4,"
 G RE
...
7 S DW="PTF;4",DV="P35.2'",DU="",DLB="ADMITTING CATEGORY",DIFLD=54
 ...
 S Y=X
 S X=Y,PAR("ADMCAT")=$S(Y:+Y,1:"") G:X="" A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD:X="@",Z
X7 Q
...
10 S DW="0;11",DV="S",DU="",DLB="ADMITTED FOR SC CONDITION?",DIFLD=.11
 S DU="1:YES;0:NO;"
 G RE
X10 S PAR("ADMSCC")=$S(Y="^":"",X:1,1:0) Q
11 S DQ=12 ;@11
12 S Y=U,DQ=12 D X12 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
