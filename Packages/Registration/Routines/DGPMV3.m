...
DR ;select input template for transaction type
 ...
 N RE,RTN,NEW,OLD
 I DGPMN D  Q:RE=0
 . S RTN="S %=$$CHKADD^DGPMAPI"_DGPMT_"(.RE,.PAR"_$S($G(PC):",.PC",1:"")_")" X RTN
 . I RE=0 W !,$P(RE(0),U,2) Q
 . S RTN="S %=$$ADD^DGPMAPI"_DGPMT_"(.RE,.PAR"_$S($G(PC):",.PC",1:"")_")" X RTN
 I 'DGPMN D  Q:RE=0
 . S RTN="S %=$$CHKUPD^DGPMAPI"_DGPMT_"(.RE,.PAR,DGDA,.OLD,.NEW"_$S($G(PC):",.PC",1:"")_")" X RTN
