DGPMAPI6 ;RGI/VSL - FACILITY TRATING SPECIALTY API; 3/4/2013
...
CHKUPD(RETURN,PARAM,MFN,NEW) ; 
 ...
 ;attender
 I $G(PARAM("ATNDPHY"))'="",+OLD(.19,"I")'=+PARAM("ATNDPHY") D  Q:'RETURN 0
 . S %=$$CHKPROV^DGPMAPI6(.RETURN,$G(PARAM("ATNDPHY")),PARAM("DATE"),"PARAM('ATNDPHY')") Q
 . S NEW("ATNDPHY")=PARAM("ATNDPHY")
 ; primary physician
 I $G(PARAM("PRYMPHY"))'="",+OLD(.08,"I")'=+PARAM("PRYMPHY") D  Q:'RETURN 0
 . S %=$$CHKPROV^DGPMAPI6(.RETURN,$G(PARAM("PRYMPHY")),PARAM("DATE"))
...
UPDFTSE(RETURN,PARAM,MFN) ; Update facility treating specialty
 S %=$$UPDFTS(.RETURN,.PARAM,.MFN) Q:'RETURN 0
 D MVTEVT^DGPMAPI7(PARAM("PATIENT"),6,+RETURN)
 Q 1
...
FTS(RETURN,PARAM) ; Add facility treating movement/provider change
 S %=$$ADDFTS(.RETURN,.PARAM) Q:'RETURN 0
 D MVTEVT^DGPMAPI7(PARAM("PATIENT"),6,+RETURN)
 Q 1
 ;
