DGPMV331 ;ALB/MIR - ASIH DISCHARGE PROCESSING ; 3/28/13
...
ASIH ;if admission type was TO ASIH...
 ...
 S TYP=$$GETAMT^DGPMDAL3(TRMAS),%=$$GETMVTT^DGPMAPI8(.TT,.TYP)
 M TMP=PAR S PAR("TYPE")=TYP,DGPMT=2,DIE("NO^")=""
 D ^DGPMX23:+$G(MVTT("MAS"))'=45,^DGPMX22:+$G(MVTT("MAS"))=45
