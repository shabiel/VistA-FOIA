DGPMV32 ;ALB/MIR - CONTINUE TRANSFER A PATIENT OPTION ;3/4/2013
 ;;5.3;Registration;**418,260005**;Aug 13, 1993
 S:$D(PAR("TYPE")) %=$$GETMVTT^DGPMAPI8(.MVTT,PAR("TYPE")),%=$$GETMASMT^DGPMAPI8(.MAS,MVTT("MAS"))
 S DGPMTYP=$G(MVTT("MAS")) I $S('DGPMTYP:1,'$G(MAS("ABS")):1,1:0) I '$G(PAR("TYPE"))!'$G(PAR("WARD")) W !,"Incomplete Transfer...Deleted" G Q
