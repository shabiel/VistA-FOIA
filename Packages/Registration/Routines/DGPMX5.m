DGPMX5 ; GENERATED FROM 'DGPM LODGER CHECK-OUT' INPUT TEMPLATE(#449), FILE 405;3/4/2013
...
X8 S Y="@53"
 Q
9 S DQ=10 ;@52
10 S Y=U,DQ=10 D X10 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ K DG G OUT^DIE17
