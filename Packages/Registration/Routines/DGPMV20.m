...
W6 W:DGONE ?30 W:'DGONE !?7 W "SPECIALTY:  ",$E($P(MVTS(I,"FTSPEC"),"^",2),1,18)
 ...
 S DGDX=$S($D(MVTS(I,"DIAG")):$E(MVTS(I,"DIAG",1),1,30),1:"") I DGDX]"" W:DGONE ?37 W:'DGONE !?7 W "DX:  ",DGDX
 K DGDX Q
ENEX ;CALLED FROM DGPMEX FOR EXTENDED BED CONTROL/EXTENDED PATIENT INQ
 ...
 F I=0:0 S I=$O(MVTS(I)) Q:'I  D WEX Q:DGFL
 I 'DGFL W !!,"DISCHARGE:" I +ADM("DISCH")>0 S %=$$GETMVT^DGPMAPI8(.DH,ADM("DISCH")),DGPMT=3,DGONE=0,I=1 M MVTS(I)=DH D WEX
