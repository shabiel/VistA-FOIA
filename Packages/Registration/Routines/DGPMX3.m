DGPMX3 ; GENERATED FROM 'DGPM DISCHARGE' INPUT TEMPLATE(#448), FILE 405;3/4/2013
 D DE G BEGIN
...
X5 S ^DISV(DUZ,"DG(405.1,")=$S($D(^DISV(DUZ,"DGPM3")):^("DGPM3"),1:"")
 Q
6 S DQ=6,DW="0;4",DV="R*P405.1'X",DU="",DLB="TYPE OF DISCHARGE",DIFLD=.04
 S DE(DW)="C6^DGPMX3"
 S DU="DG(405.1,"
 G RE
...
X8 I $P(^DG(405.1,+PAR("TYPE"),0),"^",3)'=10 S Y="@31"
 Q
