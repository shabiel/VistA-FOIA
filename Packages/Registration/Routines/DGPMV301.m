DGPMV301 ;ALB/MIR - ENTER TRANSACTION INFORMATION;4/1/13
 ;;5.3;Registration;**34,271,260005**;Aug 13, 1993
 ;
...
NEW ;Entry point to add a new entry to ^DGPM
 ...
 S DA=+Y L +^DGPM(+Y):DTIME S ^DGPM(+Y,0)=DGPM0ND,^("USR")=DUZ_"^"_DGNOW
 D
