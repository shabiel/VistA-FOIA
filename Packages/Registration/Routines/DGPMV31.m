DGPMV31 ;ALB/MIR - CONTINUE ADMIT PROCESS ; 8/26/13
...
DICS S DGER=0 I DGPMTYP=40 S DGER=1 Q  ;no TO ASIH!
 I $P(DGPMP,"^",18)=40 S DGER=1 Q  ;don't let them change from TO ASIH!
 Q:DGPMTYP'=18
 S DGX1=9999999.9999999-$S($D(^UTILITY($J,"DGAPIDT")):+^UTILITY($J,"DGAPIDT"),1:+^DGPM(DA,0))
