DGPMV31 ;ALB/MIR - CONTINUE ADMIT PROCESS ; 1/10/2013
 ;;5.3;Registration;**43,114,418,260003**;Aug 13, 1993
 I (DGPMN&DGPMOUT) D KILL G DQ
 I 'DGPMOUT D ^DGPMX6 Q
...
DICS S DGER=0 I DGPMTYP=40 S DGER=1 Q  ;no TO ASIH!
 I $P($G(^DGPM(DA,0)),"^",18)=40 S DGER=1 Q  ;don't let them change from TO ASIH!
 Q:DGPMTYP'=18
 S DGX1=9999999.9999999-$S(DA>0:+^DGPM(DA,0),1:DGX)
