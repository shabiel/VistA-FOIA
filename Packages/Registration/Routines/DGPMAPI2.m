DGPMAPI2 ;RGI/VSL - TRANSFER PATIENT API; 2/11/2013
...
CHKTRA(RETURN,PARAM,TYPE,MAS,LMVT) ; Check transfer parameters
 ...
 I +PARAM("DATE")<+LMVT("ADMDT") S RETURN=0 D ERRX^DGPMAPIE(.RETURN,"TRANBADM") Q 0
...
TRANSF(RETURN,PARAM) ; Transfer patient
 ...
 . I TYPE=14,LMVT("DISIFN")>0 S %=$$DELDSCH^DGPMAPI3(.RETURN,LMVT("DISIFN"))
...
CHKUPD(RETURN,PARAM,TFN,OLD,NEW) ; Check transfer parameters
 N %,TXT,MTYPE,WARD K RETURN S RETURN=1
 ; transfer date
...
DELTRA(RETURN,TFN) ; Delete transfer
 N %,TRA,I,RPHY,NMVT,PMVT,PAR,LMVT
 K RETURN S RETURN=0
 D INITEVT^DGPMDAL1
 ...
 I TRA(.18,"I")=43,NMVT(.18,"I")=42 S %=$$DELDSCH^DGPMAPI3(.RETURN,NMVT("ID"))
