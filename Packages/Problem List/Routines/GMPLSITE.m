...
SET(RETURN,PARAMS) ;
 ...
 . I PARAMS(I)'=1,PARAMS(I)'=0 S HASERR=1 D ERR^GMPLAPIE("RETURN","INVALIDPARAM",PARAMS(I)_" @"_I) Q
 I HASERR Q 0
 ...
 S:$D(PARAMS("REV")) FDAROOT(125.99,"1,",4)=$S(PARAMS("REV"):"R",1:"C")
 S:$D(PARAMS("SDP")) FDAROOT(125.99,"1,",6)=$S(PARAMS("SDP"):1,1:"@")
