...
VERIFY ; -- verify a transcribed problem, if parameter on
 ...
 D:GMPSAVED EN^DDIOL("",,"!")
 I 'GMPSAVED D EN^DDIOL("","","!") H 2
 . I $P($G(GMPERR(0)),U)="INACTICD" D EN^DDIOL($$EZBLD^DIALOG(1250000.629),,"?0") Q
 . I $P($G(GMPERR(0)),U)="PRBVRFD" D EN^DDIOL($$EZBLD^DIALOG(1250000.630),,"?0") Q
