...
NOTES ; -- annotate a problem
 ...
 I '$$NEWNOTE^GMPL1(GMPIFN,$G(GMPROV),GMPVAMC,"GMPERR") W !!,$$FIRSTERR^GMPLAPIE("GMPERR") H 2 G NTQ
 S VALMBCK="R",GMPRINT=1
...
DELETE ; -- delete a problem
 N GMPLSEL,GMPLNO,GMPLNUM,GMPI,GMPQUIT,GMPIFN,GMPRINT,GMPERR,GMPSAVED
 ...
 F GMPI=1:1:GMPLNO S GMPLNUM=$P(GMPLSEL,",",GMPI) I GMPLNUM D  Q:$D(GMPQUIT)
 . S GMPIFN=$P($G(^TMP("GMPLIDX",$J,+GMPLNUM)),U,2) Q:GMPIFN'>0
 . I '$$DELETE^GMPL1(GMPIFN,$G(GMPROV),GMPVAMC,"GMPERR") W !!,$$FIRSTERR^GMPLAPIE("GMPERR")
 I GMPSAVED D
