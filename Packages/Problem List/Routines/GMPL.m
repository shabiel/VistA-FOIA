...
EN ; -- main entry point for GMPL PROBLEM LIST
 ;;;
 S %=$$NEW^SDWLAPI1(.SDWLIEN,.SDWLD)
 S %=$$DETAIL^SDWLAPI1(.SDWLDET,.SDWLIEN)
 D LIST^SDWLAPI1(.RETURN)
 D HASENTRY^SDWLAPI1(.SDWLHE,SDWLDFN)
 S %=$$UPDATE^SDWLAPI1(.RETURN,SDWLIEN,.SDWLD)
 D DISP^SDWLAPI1(.RETURN,SDWLDFN)
 S %=$$DELETE^SDWLAPI1(.SDWLDEL,SDWLIEN)
 ;;;
 S GMPLUSER=1
