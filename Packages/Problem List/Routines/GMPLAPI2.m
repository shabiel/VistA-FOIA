GMPLAPI2 ; RGI/CBR Problem List API - NEW,DELETE,VERIFY,VIEW DETAILED INFO,ADD NOTE ; 09/13/12
...
DETAIL(RETURN,GMPIFN,GMPLMGR,GMPROV) ; 
 ...
 ;COMMENTS
 D NOTES^GMPLDAL3(.NOTES,GMPIFN,4,,$$GMPVAMC,$S($G(GMPLMGR)'="":GMPROV,1:""))
 S RETURN(10,0)=NOTES
...
DUPL(RETURN,GMPDFN,TERM,TEXT,GMPBOTH) ; Check's for Duplicate Entries
 ...
 D GETPLIST^GMPLDAL(.PLIST,.TOTAL,GMPDFN)
 Q:PLIST(0)=0 1
