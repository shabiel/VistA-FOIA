...
NEWNOTE(GMPIFN,GMPROV,GMPVAMC,NOTES,ERT) ; Creates New Note Entries for Problem
 ...
 S ERT=$G(ERT)
 I '$D(NOTES) D ERR^GMPLAPIE(ERT,"INVPARAM","NOTES") Q 0
 I $G(GMPIFN)="" D ERR^GMPLAPIE(ERT,"INVPARAM","GMPIFN") Q 0
 I $G(GMPVAMC)="" D ERR^GMPLAPIE(ERT,"INVPARAM","GMPVAMC") Q 0
 D DELETED^GMPLAPI2(.DELETED,GMPIFN)
 I DELETED D ERR^GMPLAPIE(ERT,"PRBDLTD"," ("_$$PROBTEXT^GMPLX(GMPIFN)_")") Q 0
 ; Code Set Versioning (CSV)
 D CODESTS^GMPLAPI2(.ICDACTV,GMPIFN,DT)
 I 'ICDACTV D ERR^GMPLAPIE(ERT,"ICDINACT"," ("_$$PROBTEXT^GMPLX(GMPIFN)_")") Q 0
